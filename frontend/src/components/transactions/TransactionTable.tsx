                        ...
                        <tr key={item.id} className="hover:bg-gray-50/50 transition-colors group">
                            ...
                            <td className="px-6 py-4">
                                <div className="flex items-center gap-3">
                                    <div
                                        className={`w-10 h-10 rounded-full flex items-center justify-center ${item.type === 'Gelir'
                            ...
                            {/* Tutar */}
                            <td
                                className={`px-6 py-4 text-right font-bold ${item.type === 'Gelir' ? 'text-green-600' : 'text-gray-900'
                                    }`}
                            >
                                {item.amount > 0
                            ...
                            <td className="px-6 py-4">
                                <div className="flex justify-center gap-3 text-gray-400">
                                    <button className="hover:text-blue-600 cursor-pointer transition-colors" type="button">
                                        <LuPencil size={18} />
                                    </button>
