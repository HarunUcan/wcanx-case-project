...
interface AddTransactionModalProps {
    isOpen: boolean;
    onClose: () => void;
    onSave?: (data: any) => void; // Veriyi kaydetmek için opsiyonel fonksiyon
}
...
const AddTransactionModal: React.FC<AddTransactionModalProps> = ({ isOpen, onClose, onSave }) => {
    ...
    const handleSave = () => {
        // Burada validasyon işlemleri yapılabilir
        if (onSave) {
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <select
                                        ...
                                        className="w-full pl-12 pr-8 py-3.5 cursor-pointer bg-white border border-gray-200 rounded-2xl text-gray-700 font-semibold outline-none focus:border-emerald-500 transition-all appearance-none cursor-pointer"
                                    >
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="w-full pl-12 pr-4 py-3.5 cursor-pointer bg-white border border-gray-200 rounded-2xl text-gray-700 font-semibold outline-none focus:border-emerald-500 transition-all cursor-pointer"
                                    />
                                </div>
                            </div>
                        </div>
